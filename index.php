<html>
<head>
	<title>♛ 𝕄𝕚𝕘ℍ𝟛𝔸𝕝𝕚𝔼𝕟 ♛ Gate-Golap</title>
...
<div class="card col-sm-8">
  <h5 class="card-body h6">CC Checker by: ♛ 𝕄𝕚𝕘ℍ𝟛𝔸𝕝𝕚𝔼𝕟 ♛(t.me/MigH3AliEn) </h5>
  <div class="card-body">
    <center><span>[♛ 𝕄𝕚𝕘ℍ𝟛𝔸𝕝𝕚𝔼𝕟 ♛]</span></center>
<div class="md-form">
	<div class="col-md-12">
  <textarea type="text" style="text-align: center;" id="lista" class="md-textarea form-control" rows="2"></textarea>
  <label for="lista">XXXXXXXXXXXXXXXX|XX|XXXX|XXX</label>
</div>
</div>
<center>
 <button class="btn btn-primary" style="width: 300px; outline: none;" id="testar" onclick="enviar()" >START</button>
  <button class="btn btn-danger" style="width: 300px; outline: none;">STOP</button>
</center>
  </div>
</div>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
<div class="card col-sm-2">
  <h5 class="card-body h6">:Info:</h5>
  <div class="card-body">
...
<footer >
    ...
    <div class="footer-copyright text-center py-3">Made with LOVE by:
      <a href="https://t.me/migh3alien">♛ 𝕄𝕚𝕘ℍ𝟛𝔸𝕝𝕚𝔼𝕟 ♛</a>
    </div>
